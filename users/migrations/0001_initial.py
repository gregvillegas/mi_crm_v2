    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Admin'), ('avp', 'AVP'), ('supervisor', 'Supervisor'), ('salesperson', 'Salesperson'), ('vp', 'Vice President'), ('gm', 'General Manager'), ('president', 'President'), ('asm', 'ASM'), ('sm', 'Sales Manager'), ('teamlead', 'Teamlead')], default='salesperson', max_length=20)),
